---
title: "ArchManual - 分布式系统架构手册"
description: "ArchManual 提供全面的分布式系统架构概览，涵盖常用分布式技术、技术主题、技术框架等。它是技术架构选型的速查手册、学习提纲、技术地图和技术社区。适用于日常工作、学习和面试准备。"
keywords: "分布式系统, 技术架构, 技术框架, 技术选型, 学习提纲, 速查手册, 技术社区, 分布式技术, 分布式架构, 技术分享"
---
# ArchManual
